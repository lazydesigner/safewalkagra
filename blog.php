...
<head>
    ...
    <meta property="og:url" content="<?= get_url() ?>blog.html" />
    ...
    <link rel="canonical" href="<?= get_url() ?>blog.html" />
    <!-- apart -->
        ...
        <div class="grid-of-blogs">
            <div class="grid-items">
                <div class="blog-card">
                    ...
                    <div class="blog-heading">
                        <a href="<?= get_url() ?>blogs/top-model-escorts-in-agra.html">
                            <h2>Enjoy your exciting party nights with Model escorts in Agra</h2>
                        </a>
                    </div>
                    <div class="blog-para">
            ...
            <div class="grid-items">
                <div class="blog-card">
                    ...
                    <div class="blog-heading">
                        <a href="<?= get_url() ?>blogs/benefits-of-hiring-high-profile-escorts-in-agra.html">
                            <h2>Glance over the sure benefits of hiring high profile escort In Agra</h2>
                        </a>
                    </div>
                    <div class="blog-para">
            ...
            <div class="grid-items">
                <div class="blog-card">
                    ...
                    <div class="blog-heading">
                        <a href="<?= get_url() ?>blogs/how-model-escorts-committed-to-friends.html">
                            <h2>How can a model escort commit to friendship?</h2>
                        </a>
                    </div>
                    <div class="blog-para">
            ...
            <div class="grid-items">
                <div class="blog-card">
                    ...
                    <div class="blog-heading">
                        <a href="<?= get_url() ?>blogs/independent-agra-escorts-near-me.html">
                            <h2>Find reliable Independent escorts in Agra to find a sensation of gratitude</h2>
                        </a>
                    </div>
                    <div class="blog-para">
            ...
            <div class="grid-items">
                <div class="blog-card">
                    ...
                    <div class="blog-heading">
                        <a href="<?= get_url() ?>blogs/dirty-divas-from-safewalkagra.html">
                            <h2>Urge for the Dirty Divas to maintain the sexual pleasure</h2>
                        </a>
                    </div>
                    <div class="blog-para">
            ...
            <div class="grid-items">
                <div class="blog-card">
                    ...
                    <div class="blog-heading">
                        <a href="<?= get_url() ?>blogs/find-best-female-companion-in-agra.html">
                            <h2>Meet with the astonishing blonde of the Agra escort service</h2>
                        </a>
                    </div>
                    <div class="blog-para">
                    ...
                    <div class="blog-read-more"><a href="<?= get_url() ?>blogs/find-best-female-companion-in-agra.html"><button aria-label="see what is inside this blog">READ MORE</button></a></div>
                </div>
            </div>
            <div class="grid-items">
                <div class="blog-card">
                    ...
                    <div class="blog-heading">
                        <a href="<?= get_url() ?>blogs/enjoy-unlimited-love-session-with-young-escorts.html">
                            <h2>Enjoy unlimited love sessions with young escort</h2>
                        </a>
                    </div>
                    <div class="blog-para">
