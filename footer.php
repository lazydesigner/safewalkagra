<footer>
    ...
    <div class="slide-to-top"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M11.9999 10.8284L7.0502 15.7782L5.63599 14.364L11.9999 8L18.3639 14.364L16.9497 15.7782L11.9999 10.8284Z"></path></svg></div>

    <a href="https://wa.me/<?=$phone_number ?>" target="_blank" aria-label="whatsapp number"><div class="whatsapp-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width: 55px;" fill="currentColor">
    ...
    <script>
        ...
        document.querySelector('.slide-to-top').addEventListener('click',()=>{
