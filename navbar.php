        ...
        <div class="container navbar">
            <div class="outter-brand-image">
                <div class="brand-image">
                    <a href="<?= get_url() ?>"><img src="<?= get_url() ?>images/our-service-your-satisfaction.webp" width="100%" height="100%" alt="Safewalkagra" aria-label="call girls in agra | Safewalkagra" loading="lazy"></a>
                </div>
