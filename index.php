...
<body>
    ...
    <nav class="nav" id="nav">
        <div class="container navbar">
            <div class="outter-brand-image">
                <div class="brand-image">
                    <a href="<?= get_url() ?>"><img src="<?= get_url() ?>images/our-service-your-satisfaction.png" width="100%" height="100%" alt=""></a>
                </div>
                <div id='menu'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white">
    ...
    <div class="whatsapp-btn"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width: 55px;" fill="currentColor">
    ...
    <script>
        ...
        window.onscroll = function() {
            if (window.pageYOffset >= 50) {
                ...
                document.querySelector('.navbar').classList.add('decreased-navbar')
                document.querySelector('.brand-image').classList.add('decreased-brand-image')
            }
            } else if (window.pageYOffset == 0) {
                if(document.querySelector('.nav').classList.contains('sticky')){
                document.querySelector('.nav').classList.remove('sticky')
                document.querySelector('.navbar').classList.remove('decreased-navbar')
                document.querySelector('.brand-image').classList.remove('decreased-brand-image')}
            }
        };

        document.getElementById('menu').addEventListener('click', () => {
            const list_of_links = document.getElementById('list-of-links');
            list_of_links.classList.toggle('tog-list-of-links')
        })
    </script>
